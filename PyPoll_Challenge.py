...
with open(file_to_save, "w") as txt_file:
    ...
    for county_name_key, county_count_value in county_voting_info.items():
        ...
        county_vote_percentage = float(
            county_count_value) / float(total_votes) * 100
        county_results = (
    ...
    largest_county_voting_summary = (
        ...
        f"Largest County Voting Percentage Out Of All Counties: {largest_county_voting_percentage:.1f}%\n"
        f"-------------------------\n\n"
        f"------Candidate Info-----\n"
    )
